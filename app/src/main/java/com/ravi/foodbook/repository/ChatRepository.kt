...
class ChatRepository @Inject constructor(val notificationApi: NotificationApi) {
    ...
    val allCurrentConversations = MutableLiveData<List<DisplayConversationDto?>>()
    var list= mutableListOf<DisplayConversationDto>()
    init {
        ...
        if (currentUser?.uid != null) {
            ...
            database.addValueEventListener(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    allCurrentConversations.value=list
                }
    ...
    val allMessagesList = MutableLiveData<List<MessageDto?>>()
    val allMessagelist= mutableListOf<MessageDto>()
    fun startConversation(
        ...
        val allMessagesListener = object : ChildEventListener {
            override fun onChildAdded(snapshot: DataSnapshot, previousChildName: String?) {
                ...
                allMessagesList.value=allMessagelist
            }
