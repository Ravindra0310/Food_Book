package com.ravi.foodbook.ui.camera
...
class CameraFragment : Fragment {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        nav_host_fragment_activity_bottom_nav.setMenuVisibility(false)
        ...
        view.apply {
            ...
            findViewById<Button>(R.id.btnSave).setOnClickListener {
                ...
                BottomNavActivity.tempPicPath = curPhoto
                if (getFileExt(view, curPhoto) == null) {
                    BottomNavActivity.tempFileExt = "jpg"
                } else {
                    BottomNavActivity.tempFileExt = getFileExt(view, curPhoto)
                }

                navController.navigate(R.id.action_cameraFragment_to_navigation_post)
    ...
    override fun onResume() {
        ...
        val activity = activity as BottomNavActivity
